...
- Google models generally allow 1 mil input tokens. One token on avg. is 4 characters, each char is 1.25 bytes (German text) on avg. in utf-8. 800 000 tokens (some buffer) * 4 chars * 1.25 bytes = 4.000.000 bytes (4 MB)
